...
export default function Login() {
  ...
  useEffect(() => {
    return () => {
      // Prevent navigation if component unmounts
    }
  }, [])

  // Feature highlights
  const features = [
    { title: 'Video Transcription', desc: 'Convert videos to text effortlessly.' },
    { title: 'SEO Keywords', desc: 'Optimize content with AI-driven keywords.' },
    { title: 'YouTube Analytics', desc: 'Track video performance metrics.' },
    { title: 'Keyword Rankings', desc: 'Monitor SEO rankings with scores.' },
  ]
      ...
      <div className="flex-grow flex items-center justify-center px-4 py-12">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className={`bg-white p-8 rounded-lg shadow-xl max-w-md w-full animate-slideIn ${error ? 'animate-shake' : ''}`}>
            ...
            <TypeAnimation
              sequence={['Boost your content with AI-driven SEO.', 2000, 'Analyze and optimize like a pro.', 2000]}
              wrapper="p"
              repeat={Infinity}
            ...
            <p className="mt-4 text-center text-gray-600">
              ...
              <Link to="/signup" className="text-indigo-600 hover:underline transform hover:scale-105 inline-block transition duration-300">
                Sign Up
              </Link>
            </p>
          </div>
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-2xl font-bold gradient-text mb-4">Why Choose SEO Keywords Guru?</h3>
            <div className="space-y-4">
              {features.map((feature, index) => (
                ...
                >
                  <h4 className="text-lg font-semibold text-indigo-600">{feature.title}</h4>
